import { SurahSimpleInfo } from '../types';

export const surahs: SurahSimpleInfo[] = [
    { number: 1, name: 'الفاتحة', englishName: 'Al-Fatiha', revelationType: 'Meccan', numberOfAyahs: 7, startPage: 1 },
    { number: 2, name: 'البقرة', englishName: 'Al-Baqara', revelationType: 'Medinan', numberOfAyahs: 286, startPage: 2 },
    { number: 3, name: 'آل عمران', englishName: 'Aal-i-Imran', revelationType: 'Medinan', numberOfAyahs: 200, startPage: 50 },
    { number: 4, name: 'النساء', englishName: 'An-Nisa', revelationType: 'Medinan', numberOfAyahs: 176, startPage: 77 },
    { number: 5, name: 'المائدة', englishName: 'Al-Maida', revelationType: 'Medinan', numberOfAyahs: 120, startPage: 106 },
    ...
    { number: 9, name: 'التوبة', englishName: 'At-Tawba', revelationType: 'Medinan', numberOfAyahs: 129, startPage: 187 },
    ...
    { number: 14, name: 'ابراهيم', englishName: 'Ibrahim', revelationType: 'Meccan', numberOfAyahs: 52, startPage: 255 },
    ...
    { number: 32, name: 'السجدة', englishName: 'As-Sajda', revelationType: 'Meccan', numberOfAyahs: 30, startPage: 415 },
    { number: 33, name: 'الأحزاب', englishName: 'Al-Ahzab', revelationType: 'Medinan', numberOfAyahs: 73, startPage: 418 },
    { number: 34, name: 'سبإ', englishName: 'Saba', revelationType: 'Meccan', numberOfAyahs: 54, startPage: 428 },
    ...
    { number: 45, name: 'الجاثية', englishName: 'Al-Jathiya', revelationType: 'Meccan', numberOfAyahs: 37, startPage: 499 },
    ...
    { number: 56, name: 'الواقعة', englishName: 'Al-Waqia', revelationType: 'Meccan', numberOfAyahs: 96, startPage: 534 },
    ...
    { number: 60, name: 'الممتحنة', englishName: 'Al-Mumtahina', revelationType: 'Medinan', numberOfAyahs: 13, startPage: 549 },
    { number: 61, name: 'الصف', englishName: 'As-Saff', revelationType: 'Medinan', numberOfAyahs: 14, startPage: 551 },
    { number: 62, name: 'الجمعة', englishName: 'Al-Jumua', revelationType: 'Medinan', numberOfAyahs: 11, startPage: 553 },
    ...
    { number: 69, name: 'الحاقة', englishName: 'Al-Haqqa', revelationType: 'Meccan', numberOfAyahs: 52, startPage: 566 },
    ...
    { number: 75, name: 'القيامة', englishName: 'Al-Qiyama', revelationType: 'Meccan', numberOfAyahs: 40, startPage: 577 },
    { number: 76, name: 'الانسان', englishName: 'Al-Insan', revelationType: 'Medinan', numberOfAyahs: 31, startPage: 578 },
    { number: 77, name: 'المرسلات', englishName: 'Al-Mursalat', revelationType: 'Meccan', numberOfAyahs: 50, startPage: 580 },
    { number: 78, name: 'النبإ', englishName: 'An-Naba', revelationType: 'Meccan', numberOfAyahs: 40, startPage: 582 },
    ...
    { number: 82, name: 'الإنفطار', englishName: 'Al-Infitar', revelationType: 'Meccan', numberOfAyahs: 19, startPage: 587 },
    { number: 83, name: 'المطففين', englishName: 'Al-Mutaffifin', revelationType: 'Meccan', numberOfAyahs: 36, startPage: 587 },
    { number: 84, name: 'الإنشقاق', englishName: 'Al-Inshiqaq', revelationType: 'Meccan', numberOfAyahs: 25, startPage: 589 },
    ...
    { number: 88, name: 'الغاشية', englishName: 'Al-Ghashiya', revelationType: 'Meccan', numberOfAyahs: 26, startPage: 592 },
    ...
    { number: 98, name: 'البينة', englishName: 'Al-Bayyina', revelationType: 'Medinan', numberOfAyahs: 8, startPage: 598 },
    { number: 99, name: 'الزلزلة', englishName: 'Az-Zalzala', revelationType: 'Medinan', numberOfAyahs: 8, startPage: 599 },
    { number: 100, name: 'العاديات', englishName: 'Al-Adiyat', revelationType: 'Meccan', numberOfAyahs: 11, startPage: 599 },
    { number: 101, name: 'القارعة', englishName: 'Al-Qaria', revelationType: 'Meccan', numberOfAyahs: 11, startPage: 600 },
    ...
    { number: 104, name: 'الهمزة', englishName: 'Al-Humaza', revelationType: 'Meccan', numberOfAyahs: 9, startPage: 601 },
